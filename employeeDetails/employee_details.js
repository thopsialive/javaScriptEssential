...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) {
    document.getElementById('employeesDetails').innerHTML =`<p>${foundEmployee.id}: ${foundEmployee.name}: ${foundEmployee.age} - ${foundEmployee.department} - $${foundEmployee.salary} - ${employee.specialization}</p>`;
    }
    else{
...
// Practice Task
function findEmployeeBySpecilization(employeeSpecilization) {
